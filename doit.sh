...
# Do 'chmod +x doit.sh' to make this script executable

# If you will do more than releasing
# I recommend doing 'alias doit="/path/to/this/script/doit.sh"' in your .bashrc or .zshrc

# Feel free to use THIS FILE without giving any atributtion
